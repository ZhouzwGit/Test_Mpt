...
public class Udstockt_Details_Activity extends BaseActivity {
    ...
    private View.OnClickListener quitOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            final NormalDialog dialog = new NormalDialog(Udstockt_Details_Activity.this);
            ...
            dialog.setOnBtnClickL(
                    ...
                    new OnBtnClickL() {
                        @Override
                        public void onBtnClick() {
                            AppManager.AppExit(Udstockt_Details_Activity.this);
                        }
                    });
    ...
    private View.OnClickListener optionOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            final NormalListDialog normalListDialog = new NormalListDialog(Udstockt_Details_Activity.this, optionList);
...
//                    linetypeTextView.setText(linetypeList[position]);
                    switch (position) {
                        ...
                        case 2://Stocktaking
                            ...
                            intent1.putExtra("status",udstockt.getSTATUS());
...
//                    normalListDialog.dismiss();
    ...
    private void MaterialDialogOneBtn() {//开始工作流
        final MaterialDialog2 dialog = new MaterialDialog2(Udstockt_Details_Activity.this);
    ...
    private void startWF() {
        mProgressDialog = ProgressDialog.show(Udstockt_Details_Activity.this, null,
        ...
        new AsyncTask<String, String, WorkFlowResult>() {
            ...
            protected WorkFlowResult doInBackground(String... strings) {
                WorkFlowResult result = AndroidClientService.startwf(Udstockt_Details_Activity.this,
                        "MPT_STOTAK", "UDSTOCKT", udstockt.getSTOCKTNUM(), "STOCKTNUM", AccountUtils.getpersonId(Udstockt_Details_Activity.this));
                return result;
            }
    ...
    private void EditDialog() {//输入审核意见
        final NormalEditTextDialog dialog = new NormalEditTextDialog(Udstockt_Details_Activity.this);
        dialog.setCancelable(false);
        dialog.setCanceledOnTouchOutside(false);
        dialog.isTitleShow(false)//
                .btnNum(3)
