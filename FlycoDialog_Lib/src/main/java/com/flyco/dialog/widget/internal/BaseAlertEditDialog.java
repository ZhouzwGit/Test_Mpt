...
public abstract class BaseAlertEditDialog<T extends BaseAlertEditDialog<T>> extends BaseDialog<T> {
    /** container */
    ...
    protected OnBtnEditClickL mOnBtnLeftClickL;
    /** right btn click listener(右按钮接口) */
    protected OnBtnEditClickL mOnBtnRightClickL;
    /** middle btn click listener(右按钮接口) */
    protected OnBtnEditClickL mOnBtnMiddleClickL;
     ...
     * @param context
     */
    public BaseAlertEditDialog(Context context) {
        super(context);
        widthScale(0.88f);
        ...
        /** content */
        mTvContent = new EditText(context);
    ...
    public void setUiBeforShow() {
        ...
        mTvTitle.setText(TextUtils.isEmpty(mTitle) ? "Tips" : mTitle);
        ...
        mTvBtnLeft.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnBtnLeftClickL != null) {
                    mOnBtnLeftClickL.onBtnClick(mTvContent.getText().toString());
                } else {
                    dismiss();
                }
            }
        ...
        mTvBtnRight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnBtnRightClickL != null) {
                    mOnBtnRightClickL.onBtnClick(mTvContent.getText().toString());
                } else {
                    dismiss();
                }
            }
        ...
        mTvBtnMiddle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnBtnMiddleClickL != null) {
                    mOnBtnMiddleClickL.onBtnClick(mTvContent.getText().toString());
                } else {
                    dismiss();
                }
            }
     ...
     */
    public void setOnBtnClickL(OnBtnEditClickL... onBtnClickLs) {
